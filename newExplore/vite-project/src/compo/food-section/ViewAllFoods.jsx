...
//         Places
//       </Typography>
//       <Box sx={{ display: "flex", justifyContent: "start", color: "#2a90d9" }}>
//         <TextField
//           variant="outlined"
//           size="small"
...
//         <Box sx={{ display: "flex", gap: 1, padding: "2em", color: "#2a90d9" }}>
//           <FilterAltIcon />
...
//               >
//                 <StarIcon
//                   sx={{ color: "#ffb400", fontSize: "1.2em", mr: 0.5 }}
//                 />
//                 4.5
//               </Box>
//             </Box>
...
//             <CardContent
//               sx={{ backgroundColor: "#fff9f8" /* very subtle coral tint */ }}
//             >
//               <Typography
//                 gutterBottom
//                 variant="h5"
...
export default function SliderFood({
  ...
  return (
    <>
      ...
      >
        All
        <span style={{ color: "#ee685f", margin: "0 0.2em" }}>Foods</span> Places
      </Typography>
